...
import image4 from '../../images/mockup1.png' ;
import image5 from '../../images/mockup5.png' ;
...
const PortfolioContent = () => {
  const timeline = gsap.timeline();
    ...
    useEffect(() => {
        ...
        const aboutText5 = document.querySelectorAll('.about-text5');
        ...
        .from(thirdImage, {opacity: 0, x: -600, duration: 1.5, stagger:0.3}, "-=1.3")
        ...
        .from(aboutText4, {opacity: 0, x: -600, duration: 1.4, stagger:0.5}, "-=1.3")
        .from(fifthImage, {opacity: 0, x: -600, duration: 1.4, stagger:0.5}, "-=1.3")
        .from(aboutText5, {opacity: 0, x: 600, duration: 1.4, stagger:0.5}, "-=1.3")
    })
    ...
    <>
      ...
      <div className="container-work">
        ...
        <div className="container-text mobile:items-center md:items-start md:pl-[6rem] md:w-[600px] md:h-[600px] flex flex-col justify-center">
          ...
          <p className="about-text3 text-[#8D8D92] mb-[10px] mobile:text-center md:text-start mobile:text-[14px] md:text-lg">Plataforma de gestión de turnos médicos.</p>
      ...
      <div className="container-work">
        <div className="container-img md:w-[600px] md:h-[600px]">
          <img src={image5} className="img-size fourth-image" alt="" />
        </div>
        <div className="container-text mobile:items-center md:items-start md:pl-[6rem] md:w-[600px] md:h-[600px] flex flex-col justify-center">
          <h4 className="about-text4">Cal.</h4>
          <p className="about-text4 text-[#8D8D92] mb-[10px] mobile:text-center md:text-start mobile:text-[14px] md:text-lg">Organizador de eventos.</p>
          <h4 className="about-text4 tech font-[500]">Tecnologías</h4>
          ...
          <p className="about-text4 w-[150px] h-[100px]"><a className="button-projects" href="https://eventorganizerapp.netlify.app/" target='_blank' rel="noreferrer" title="View site here">View site here</a></p>
        </div>
      </div>
      ...
      <div style={{"marginBottom":"200px"}} className="container-work">
        <div className="container-img md:w-[600px] md:h-[600px]">
          <img src={image4} className="img-size fifth-image" alt="" />
        </div>
        <div className="container-text mobile:items-center md:items-start md:pl-[6rem] md:w-[600px] md:h-[600px] flex flex-col justify-center">
          <h4 className="about-text5">FlickPick</h4>
          <p className="about-text5 text-[#8D8D92] mb-[10px] mobile:text-center md:text-start mobile:text-[14px] md:text-lg">Plataforma de salas de cine interactivas.</p>
          <h4 className="tech about-text5 font-[500]">Tecnologías</h4>
          <ul className="tech-list about-text5">
          ...
          <p className="about-text5 w-[150px] h-[100px]"><a className="button-projects" href="https://flickpickapp.netlify.app/" target='_blank' rel="noreferrer" title="View site here">View site here</a></p>
        </div>
      </div>
{/* 
      <div className="container-work">
