    ...
    <>
      <div className="container-work">
        ...
        <div className="container-text mobile:items-center md:items-start md:pl-[6rem] md:w-[600px] md:h-[600px] flex flex-col justify-center">
          ...
          <p className="about-text w-[150px] h-[100px]"><a className="button-projects" href="https://euphodesign.netlify.app/" target='_blank' rel="noreferrer" title="View site here">View site here</a></p>
        </div>
      </div>
